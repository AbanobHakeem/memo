    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-primary navbar-badge">{{ LaravelLocalization::getCurrentLocale() }}</span>
            </a>
...
<form id="logout" action="{{ route('dashboard.logout') }}" class="d-none" method="POST">
    @csrf
</form>
<!-- /.navbar -->
