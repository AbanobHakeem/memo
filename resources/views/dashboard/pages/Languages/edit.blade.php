                ...
                <div class="row">
                    ...
                    <div class="card card-primary col-12">
                        <div class="card-header">
                            <h3 class="card-title">Edit Laguage</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('dashboard.languages.update', $lang->id) }}">
                            @csrf
                            @method("PUT")
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="dir" class="form-control select2 @error('dir') is-invalid @enderror "
                                        style="width: 100%">
                                        <option @if ($lang->dir == 'rtl') selected @endif value="rtl">RTL</option>
                                        <option @if ($lang->dir == 'ltr') selected @endif value="ltr">LTR</option>
                                    </select>
                                    @error('dir')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
