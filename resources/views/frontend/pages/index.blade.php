        ...
        <div id="category-filter">
            <ul class="category-list">
                <li class="category-item adults">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-01.jpg"
                            alt="New Releaase" />
                ...
                <li class="category-item kids-teens">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-02.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item video">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-03.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item audio">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-04.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item books">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-05.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item magazines">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-06.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item adults">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-07.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item kids-teens">
                    <figure>
                        <img src="{{ asset('frontend') }}/images/category-filter/home-v1/category-filter-img-08.jpg"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
            ...
            <div class="tabs-container">
                ...
                <div class="tabs-list">
                    ...
                    <div class="tab-content">
                        <article>
                            <figure>
                                <img src="{{ asset('frontend') }}/images/latest-blog-img-home-v1-2.jpg"
                                    alt="Latest Blog">
                                <figcaption>
                                    <a href="#.">
    ...
    <section class="news-events section-padding banner">
        <div class="container">
            <div class="center-content">
                ...
                <span class="underline center"></span>
                <p class="lead c-light">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below
                    for those interested.</p>
            </div>
