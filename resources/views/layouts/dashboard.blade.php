...
<head>
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{ asset('control') }}/plugins//jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('control') }}/dist//css/adminlte.min.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="{{ asset('control') }}/plugins//overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- Sparkline -->
    <script src="{{ asset('control') }}/plugins//sparklines/sparkline.js"></script>
    <!-- JQVMap -->
    <script src="{{ asset('control') }}/plugins//jqvmap/jquery.vmap.min.js"></script>
    <script src="{{ asset('control') }}/plugins//jqvmap/maps/jquery.vmap.usa.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="{{ asset('control') }}/plugins//jquery-knob/jquery.knob.min.js"></script>
    <!-- daterangepicker -->
    ...
    <!-- overlayScrollbars -->
    <script src="{{ asset('control') }}/plugins//overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
    <!-- AdminLTE App -->
    <script src="{{ asset('control') }}/dist//js/adminlte.js"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="{{ asset('control') }}/dist//js/pages/dashboard.js"></script>
</body>
